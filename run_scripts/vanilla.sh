...
# ---- Dataset 4: Alpaca GPT-4 ----
# dataset_name="vicgalle/alpaca-gpt4"
# dataset_sample=52002

# ---- Dataset 5: Local data ----
# local_data_dir=""     # Uncomment if using local dataset
# dataset_name="your_local_dataset"
# dataset_sample=20000

# ---- Dataset 6: FinGPT (default, used here) ----
dataset_name="FinGPT/fingpt-sentiment-train"
dataset_sample=76772   # Limit the dataset for efficiency

# ========= Run training =========
CUDA_VISIBLE_DEVICES=$gpu python vanilla_llm.py \
    --learning_rate $lr \
    ...
    --template "alpaca"  # Always using "alpaca" as the template for training
